      ...
      <div class="modal-body">
          <form>
            ...
            <div class="gap-2 d-flex text-center justify-content-center">
              <a class="btn background-color-gray" data-bs-dismiss="modal" aria-label="Close">Cancel</a>
...
<div class="modal fade" id="ViewEventBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="ViewEventBackdrop" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
